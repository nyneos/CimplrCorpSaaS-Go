...
func RegisterFXRoutes(mux *http.ServeMux, serviceName string, pgxPool *pgxpool.Pool) {
	...
	mux.Handle("/fx/exposures/hedging-proposals/package-zip", midFX(exposures.DownloadHedgingProposalPackageZipHandler(pgxPool)))
	mux.Handle("/fx/exposures/hedging-proposals/additional-files/list", midFX(exposures.ListHedgingProposalAdditionalFilesHandler(pgxPool)))
	mux.Handle("/fx/exposures/hedging-proposals/additional-files/upload", midFX(exposures.UploadHedgingProposalAdditionalFilesHandler(pgxPool)))
	mux.Handle("/fx/exposures/hedging-proposals/additional-files/download", midFX(exposures.DownloadHedgingProposalAdditionalFileHandler(pgxPool)))
	mux.Handle("/fx/exposures/hedging-proposals/additional-files/download-bulk", midFX(exposures.DownloadSelectedHedgingProposalAdditionalFilesHandler(pgxPool)))
	mux.Handle("/fx/exposures/hedging-proposals/additional-files/delete", midFX(exposures.DeleteHedgingProposalAdditionalFileHandler(pgxPool)))
	mux.Handle("/fx/exposures/hedging-proposals/additional-files/audit", midFX(exposures.AuditHedgingProposalAdditionalFileHandler(pgxPool)))
	mux.Handle("/fx/exposures/hedging-proposals/additional-files/delete/approve", midFX(exposures.ApproveHedgingProposalAdditionalFileDeleteHandler(pgxPool)))
	mux.Handle("/fx/exposures/hedging-proposals/additional-files/delete/reject", midFX(exposures.RejectHedgingProposalAdditionalFileDeleteHandler(pgxPool)))
	/*linkage */
	mux.Handle("/fx/exposures/hedge-links-details", midFX(exposures.HedgeLinksDetails(pgxPool)))
	mux.Handle("/fx/exposures/linkage/package-zip", midFX(exposures.DownloadExposureLinkagePackageZipHandler(pgxPool)))
	mux.Handle("/fx/exposures/linkage/additional-files/list", midFX(exposures.ListExposureLinkageAdditionalFilesHandler(pgxPool)))
	mux.Handle("/fx/exposures/linkage/additional-files/upload", midFX(exposures.UploadExposureLinkageAdditionalFilesHandler(pgxPool)))
	mux.Handle("/fx/exposures/linkage/additional-files/download", midFX(exposures.DownloadExposureLinkageAdditionalFileHandler(pgxPool)))
	mux.Handle("/fx/exposures/linkage/additional-files/download-bulk", midFX(exposures.DownloadSelectedExposureLinkageAdditionalFilesHandler(pgxPool)))
	mux.Handle("/fx/exposures/linkage/additional-files/delete", midFX(exposures.DeleteExposureLinkageAdditionalFileHandler(pgxPool)))
	mux.Handle("/fx/exposures/linkage/additional-files/audit", midFX(exposures.AuditExposureLinkageAdditionalFileHandler(pgxPool)))
	mux.Handle("/fx/exposures/linkage/additional-files/delete/approve", midFX(exposures.ApproveExposureLinkageAdditionalFileDeleteHandler(pgxPool)))
	mux.Handle("/fx/exposures/linkage/additional-files/delete/reject", midFX(exposures.RejectExposureLinkageAdditionalFileDeleteHandler(pgxPool)))
	...
	mux.Handle("/fx/exposures/settlements/package-zip", midFX(exposures.DownloadExposureSettlementPackageZipHandler(pgxPool)))
	mux.Handle("/fx/exposures/settlements/additional-files/list", midFX(exposures.ListExposureSettlementAdditionalFilesHandler(pgxPool)))
	mux.Handle("/fx/exposures/settlements/additional-files/upload", midFX(exposures.UploadExposureSettlementAdditionalFilesHandler(pgxPool)))
	mux.Handle("/fx/exposures/settlements/additional-files/download", midFX(exposures.DownloadExposureSettlementAdditionalFileHandler(pgxPool)))
	mux.Handle("/fx/exposures/settlements/additional-files/download-bulk", midFX(exposures.DownloadSelectedExposureSettlementAdditionalFilesHandler(pgxPool)))
	mux.Handle("/fx/exposures/settlements/additional-files/delete", midFX(exposures.DeleteExposureSettlementAdditionalFileHandler(pgxPool)))
	mux.Handle("/fx/exposures/settlements/additional-files/audit", midFX(exposures.AuditExposureSettlementAdditionalFileHandler(pgxPool)))
	mux.Handle("/fx/exposures/settlements/additional-files/delete/approve", midFX(exposures.ApproveExposureSettlementAdditionalFileDeleteHandler(pgxPool)))
	mux.Handle("/fx/exposures/settlements/additional-files/delete/reject", midFX(exposures.RejectExposureSettlementAdditionalFileDeleteHandler(pgxPool)))
