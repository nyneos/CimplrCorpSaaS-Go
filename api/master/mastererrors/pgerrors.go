...
var uniqueMessages = map[string]string{
	// AMC
	"unique_amc_name_not_deleted":           "AMC name already exists. Please use a different name.",
	"unique_internal_amc_code_not_deleted":  "Internal AMC code already exists. Please use a different code.",
	"unique_amc_code_not_deleted":           "Internal AMC code already exists. Please use a different code.", // legacy alias
	"masteramc_amc_name_key":                "AMC name already exists. Please use a different name.",
	"masteramc_internal_amc_code_key":       "Internal AMC code already exists. Please use a different code.",
	"unique_sebi_registration_not_deleted": "SEBI registration number already exists.",
	"masteramc_sebi_registration_number_key": "SEBI registration number already exists.",
	...
	"unique_entity_name_not_deleted":          "Entity name already exists. Please use a different name.",
	"idx_masterentitycash_name_not_deleted":   "Entity name already exists. Please use a different name.",
...
var columnMessages = map[string]string{
	"internal_amc_code":     "Internal AMC code already exists. Please use a different code.",
	"amc_name":              "AMC name already exists. Please use a different name.",
	"sebi_registration_no":  "SEBI registration number already exists.",
	...
	"entity_name":           "Entity name already exists. Please use a different name.",
