...
const checklistItemSelect = `
	SELECT
		...
		COALESCE(TO_CHAR((i.last_updated_at AT TIME ZONE 'Asia/Kolkata'),'YYYY-MM-DD HH24:MI:SS'),'') AS last_updated_at,
		TO_CHAR((i.created_at AT TIME ZONE 'Asia/Kolkata'),'YYYY-MM-DD HH24:MI:SS') AS created_at,
