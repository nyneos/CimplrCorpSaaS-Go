...
import (
	bankbalance "CimplrCorpSaas/api/dash/bankBalance"
	...
	fxops "CimplrCorpSaas/api/dash/fxOps"
	hedgeproposal "CimplrCorpSaas/api/dash/hedgingProposal"
	investmentdashboards "CimplrCorpSaas/api/dash/investmentDashboards"
	landingpage "CimplrCorpSaas/api/dash/landingPage"
...
// RegisterDashRoutes wires every /dash/* route onto mux. Route registration
// only — handler logic lives in the respective dash subpackages.
func RegisterDashRoutes(mux *http.ServeMux, serviceName string, pgxPool *pgxpool.Pool) {
