...
func StartCashService(db *sql.DB, port string) {
	...
	mux.Handle("/cash/rule-master/additional-files/list", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.ListRuleMasterAdditionalFilesHandler(pgxPool)))
	mux.Handle("/cash/rule-master/additional-files/upload", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.UploadRuleMasterAdditionalFilesHandler(pgxPool)))
	...
	mux.Handle("/cash/smart-cat/rules/ai-suggested", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.ListAISuggestedRulesHandler(pgxPool)))
	mux.Handle("/cash/smart-cat/rule/approve", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.ApproveAIRuleHandler(pgxPool)))
	mux.Handle("/cash/smart-cat/rule/reject", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.RejectAIRuleHandler(pgxPool)))
	// AI Bulk Suggest — batch-classify all PENDING UNALLOCATED review queue items
	mux.Handle("/cash/smart-cat/ai-bulk-suggest", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.AiBulkSuggestHandler(pgxPool)))
	// Bulk Correct — apply a category to N transactions at once
	mux.Handle("/cash/smart-cat/bulk-correct", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.BulkCorrectHandler(pgxPool)))
	...
	mux.Handle("/cash/bank-statements/v2/additional-files/list", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.ListAdditionalFilesHandler(pgxPool)))
	mux.Handle("/cash/bank-statements/v2/additional-files/upload", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.UploadAdditionalFilesHandler(pgxPool)))
	...
	mux.Handle("/cash/bank-statements/v2/audit/balance-impact", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.GetBankStatementBalanceImpactAuditHandler(db)))
	mux.Handle("/cash/bank-statements/v2/audit/transactions", middlewares.PreValidationMiddleware(pgxPool)(bankstatement.GetBankStatementTransactionAuditHandler(db)))
	// -----------
	...
	mux.Handle("/cash/transactions/payables/additional-files/list", api.BusinessUnitMiddleware(db)(payablerecievable.ListPayableAdditionalFilesHandler(pgxPool)))
	mux.Handle("/cash/transactions/payables/additional-files/upload", api.BusinessUnitMiddleware(db)(payablerecievable.UploadPayableAdditionalFilesHandler(pgxPool)))
	...
	mux.Handle("/cash/fund-planning/additional-files/list", api.BusinessUnitMiddleware(db)(fundplanning.ListAdditionalFilesHandler(pgxPool)))
	mux.Handle("/cash/fund-planning/additional-files/upload", api.BusinessUnitMiddleware(db)(fundplanning.UploadAdditionalFilesHandler(pgxPool)))
	...
	mux.Handle("/cash/projection/v2/additional-files/list", middlewares.PreValidationMiddleware(pgxPool)(projection.ListAdditionalFilesHandler(pgxPool)))
	mux.Handle("/cash/projection/v2/additional-files/upload", middlewares.PreValidationMiddleware(pgxPool)(projection.UploadAdditionalFilesHandler(pgxPool)))
	...
	mux.Handle("/cash/bank-balances/audit", middlewares.PreValidationMiddleware(pgxPool)(bankbalances.GetBankBalanceAuditHandler(pgxPool)))
	...
	mux.Handle("/cash/bank-balances/additional-files/list", middlewares.PreValidationMiddleware(pgxPool)(bankbalances.ListAdditionalFilesHandler(pgxPool)))
	mux.Handle("/cash/bank-balances/additional-files/upload", middlewares.PreValidationMiddleware(pgxPool)(bankbalances.UploadAdditionalFilesHandler(pgxPool)))
