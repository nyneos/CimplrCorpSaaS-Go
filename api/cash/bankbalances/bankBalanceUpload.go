...
func ubParseUploadFile(file io.Reader, ext string) ([][]string, error) {
	if ext == ".csv" {
...
// 					}
// 				}
// 				// balance_id is auto-generated by database DEFAULT, no need to add here
...
// 								// Use pool connection, not tx, to avoid "conn busy" error while cursor is open
...
// 											}
// 										}
// 										// Use pool connection, not tx, to avoid "conn busy" error
